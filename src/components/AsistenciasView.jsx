    ...
    <div style={{ padding: 20 }}>
      ...
      <div style={S.card}>
        <div style={{ padding: "14px 20px", borderBottom: "1px solid #E5E7EB", background: "#F9FAFB" }}>
          ...
          <div style={{ fontSize: 13, color: "#6B7280", marginTop: 2, fontWeight: 500 }}>{programaActual} · {selectedDay.charAt(0)+selectedDay.slice(1).toLowerCase()} · Turno: {turno === "DIURNO" ? "Diurno (7:30AM – 12:00PM)" : "Vespertino (1:00PM – 5:30PM)"} · Trimestre {lapsoActual}</div>
        </div>
            ...
            <tbody>
              {docentesDelDia.map(([rd, info], idx) => (
                <tr key={rd} style={{ background: idx % 2 === 0 ? "#fff" : "#FAFAFB" }}>
                  ...
                  <td style={{ ...S.td, border: "1px solid #E5E7EB", minHeight: 48, height: 48 }}></td>
                  <td style={{ ...S.td, border: "1px solid #E5E7EB", minHeight: 48, height: 48 }}></td>
                  <td style={{ ...S.td, border: "1px solid #E5E7EB", minHeight: 48, height: 48 }}></td>
                </tr>
              ))}
